        ...
        <td valign="top">
            <table class="detail_table">
                ...
                <tr>
                    ...
                    <td class="value" colspan="3"><input class="form-control" type="text" id="shopName" name="shopName" value='' placeholder="가계 이름"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="value"><input id="discountRateValue" name="discountRateValue" value="0.00"></input></td>
                    <td class="label"><span class="required">* </span>Shop 크리딧 </td>
                    <td class="value"><input id="shopCredit" name="shopCredit" value="0"></input></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="value" style="padding-left: 3px;">
                        <table>
                            <tr>
                                <td><input class="form-control" type="text" id="addressPostcode" name="addressPostcode" value='' style="width: 80px;" maxlength="4"/></td>
                    ...
                    <td class="value">
                        <div id="cbx_addressSuburb"><input class="form-control" type="text" id="addressSuburb" name="addressSuburb" value=''/></div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="value"><input id="deliveryBaseCharge" name="deliveryBaseCharge" value="0"></input></td>
                ...
                <tr>
                    ...
                    <td class="value" style="padding-left: 3px;">
                        <table>
                            <tr>
                                <td><input class="form-control" type="text" id="forDeliverCalcAddressPostcode" name="forDeliverCalcAddressPostcode" value='' style="width: 80px;" maxlength="4"/></td>
                    ...
                    <td class="value">
                        <div id="cbx_forDeliverCalcAddressSuburb"><input class="form-control" type="text" id="forDeliverCalcAddressSuburb" name="forDeliverCalcAddressSuburb" value=''/></div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="value" colspan="4"><textarea class="form-control" style="height:100px;" id="notice" name="notice"></textarea></td>
                </tr>
    ...
    <tr>
        <td>
            <table class="action_button_table" width="100%">
                <tr>
                    <td>
                        <a href="javascript:goList();" class="btn btn-info">&nbsp;&nbsp; Close &nbsp;&nbsp;</a>
