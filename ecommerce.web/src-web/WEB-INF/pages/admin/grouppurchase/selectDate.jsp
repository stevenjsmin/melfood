            ...
            $("#grid_panel_main").kendoGrid({
                ...
                columns: [
                    ...
                    {hidden: true, field: "state"},
                    {
                        ...
                        field: 'stateLabel',
                        width: 150,
                        attributes: {style: "color: 606000; font-weight: bolder;"},
                        filterable: false
                    },
                    {
                        title: 'Postcode',
                        field: 'postcode',
                        width: 100,
                        attributes: {style: "color: 939300; font-weight: bolder;"}
                    },
                    {
                        title: 'Suburb',
                        field: 'suburb',
                        width: 200,
                        attributes: {style: "color: e37200;font-weight: bolder;"}
                    },
...
<div id="searchForFullAddr" style="display: block; ">
    <table class="detail_table_c">
        ...
        <tr>
            ...
            <td class="value" style="padding-left: 3px;">
                <table>
                    <tr>
                        <td><input class="form-control" type="text" id="sellerPickupAddressPostcode"
                                   name="sellerPickupAddressPostcode" value='${defaultPickupPostcode}'
                                   style="width: 80px;" maxlength="4"/></td>
                        <td><img src="/resources/image/lookup.png" style="cursor: pointer;"
                                 onclick="setSuburbCbx('sellerPickupAddressPostcode', 'sellerPickupAddressSuburb')">
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td class="value">
                <div id="cbx_sellerPickupAddressSuburb"><input class="form-control" type="text"
                                                               id="sellerPickupAddressSuburb"
                                                               name="sellerPickupAddressSuburb"
                                                               value='${defaultPickupSurbub}'/></div>
            </td>
        </tr>
        <tr>
            <td class="label"><span class="required">* </span>Street</td>
            <td class="value" colspan="2"><input class="form-control" type="text" id="sellerPickupAddressStreet"
                                                 name="sellerPickupAddressStreet" value='${defaultPickupStreet}'/></td>
            <td></td>
        </tr>
        <tr>
            <td class="label">Comment</td>
            <td class="value" colspan="3"><input class="form-control" type="text" id="addressNote" name="addressNote"
                                                 value='' maxlength="230"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" style="text-align: right;">
                <button type="button" class="btn btn-default btn-sm" onclick="parent.closeOptionWindow();">Close
                </button>
                &nbsp;&nbsp;&nbsp;
                <button type="button" class="btn btn-primary btn-sm" onclick="addDeliveryCalendarFromScreen();">Add
                </button>
                &nbsp;&nbsp;
            </td>
        </tr>
...
<div id="searchForSimpleAddr" style="display: none; ">
    ...
    <div class="well">
        <table class="search_table">
            <tr>
                ...
                <td class="value"><input class="form-control" type="text" id="postcode" name="postcode" value=''
                                         maxlength="4"/></td>
