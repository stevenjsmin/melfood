...
<script>
     var items = [
           ...
           {id: 120,  text: "상품 관리", LinksTo: "/admin/productmgt/Main.yum", image: "/resources/css/images/gic/ic_card_giftcard_black_18dp_1x.png" },
           {id: 130,  text: "구매전확인사항 관리", LinksTo: "/admin/checkbeforebuy/Main.yum", image: "/resources/css/images/gic/ic_playlist_add_check_black_18dp_1x.png" }
       	] },
