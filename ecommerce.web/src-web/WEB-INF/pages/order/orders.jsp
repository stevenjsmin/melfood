...
<head>
    ...
    <script id="command-statusPayment-template" type="text/x-kendo-template">
        # if (statusPayment == 'BEFORE_PAYMENT') { #
                <a class="k-button" onclick="paymentStatusToggle('#=orderMasterId#')" style="color: F15F4C;">결재처리중 처리</a>
        # } else if (statusPayment == 'ON_PROCESSING') { #
                <a class="k-button" onclick="paymentStatusToggle('#=orderMasterId#')" style="color: 337AB7;">완료 처리</a>
        # } else if (statusPayment == 'COMPLETED') { #
                <a class="k-button" onclick="paymentStatusToggle('#=orderMasterId#')" style="color: B8A8A;">결재전 처리</a>
        # } else { #
                #=statusPayment #
        # } #
    </script>
